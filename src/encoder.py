...
class Encoder(torch.nn):
    def __init__(self, delta1=0.5, delta2=0.5, delta3=0.3):
        ...
        self.fc_1 = torch.nn.Linear(in_features=640,out_features=1000) # TODO: make it work U=1000
        self.dropout_2 = torch.nn.Dropout(p=delta2)
        self.fc_2 = torch.nn.Linear(in_features=1000, out_features=100) # TODO: make it work U=100
        self.dropout_3 = torch.nn.Dropout(p=delta3)
        self.fc_3 = torch.nn.Linear(in_features=100, out_features=10) # TODO: make it work U = 10
